...
typedef void (*VirtualMemoryOperationMappingPages)(struct VirtualMemory *virtualMemory, uint32_t virtualAddress,
...
typedef struct VirtualMemoryOperations {
    ...
    VirtualMemoryOperationMappingPages mappingPages;
