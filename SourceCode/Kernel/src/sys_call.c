...
int sys_test2(int arg1,int arg2){
  LogWarnning("[SysCall] syscall test1 invoked. arg1: %d \n",arg1);
  LogWarnning("[SysCall] syscall test1 invoked. arg2: %d \n",arg2);
  return 0;
}
int sys_test3(int arg1,int arg2,int arg3){
  LogWarnning("[SysCall] syscall test1 invoked. arg1: %d \n",arg1);
  LogWarnning("[SysCall] syscall test1 invoked. arg2: %d \n",arg2);
  LogWarnning("[SysCall] syscall test1 invoked. arg3: %d \n",arg3);
  return 0;
}
int sys_test4(int arg1,int arg2,int arg3,int arg4){
  ...
  LogWarnning("[SysCall] syscall test1 invoked. arg2: %d \n",arg2);
  LogWarnning("[SysCall] syscall test1 invoked. arg3: %d \n",arg3);
  LogWarnning("[SysCall] syscall test1 invoked. arg4: %d \n",arg3);
  return 0;
}
int sys_test5(int arg1,int arg2,int arg3,int arg4,int arg5){
  ...
  LogWarnning("[SysCall] syscall test1 invoked. arg3: %d \n",arg3);
  LogWarnning("[SysCall] syscall test1 invoked. arg4: %d \n",arg3);
  LogWarnning("[SysCall] syscall test1 invoked. arg5: %d \n",arg5);
   return 0;
}
