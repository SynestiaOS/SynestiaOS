...
uint32_t sys_clone(unsigned long clone_flags, unsigned long newsp, int *parent_tidptr, int tls_val, int *child_tidptr);
...
uint32_t sys__llseek(uint32_t fd, unsigned long offset_high, unsigned long offset_low,
...
uint32_t sys_clock_nanosleep(const uint32_t which_clock, int flags, const uint32_t *rqtp, uint32_t *rmtp);
...
uint32_t sys_request_key(const char *_type, const char *_description, const void *_payload, uint32_t plen, uint32_t ringid);
...
uint32_t sys_mbind(unsigned long start, unsigned long len, unsigned long mode, unsigned long *nmask, unsigned long maxnode, unsigned flags);

uint32_t sys_get_mempolicy(int fd, const char *pathname, uint32_t mask);

uint32_t sys_set_mempolicy(int fd, int32_t wd);

uint32_t sys_openat(int *policy, unsigned long *nmask, unsigned long maxnode, unsigned long addr, unsigned long flags);
...
uint32_t sys_move_pages(uint32_t pid, unsigned long nr_pages, const void **pages,
...
uint32_t sys_signalfd(unsigned long entry, unsigned long nr_segments,
...
uint32_t sys_preadv(unsigned long fd, const uint32_t *vec, unsigned long vlen, unsigned long pos_l, unsigned long pos_h);

uint32_t sys_pwritev(unsigned long fd, const uint32_t *vec, unsigned long vlen, unsigned long pos_l, unsigned long pos_h);

uint32_t sys_rt_tgsigqueueinfo(uint32_t tgid, uint32_t pid, int sig, uint32_t *uinfo);

uint32_t sys_perf_event_open(uint32_t *attr_uptr, uint32_t pid, int cpu, int group_fd, unsigned long flags);
...
uint32_t sys_process_vm_readv(uint32_t pid, const uint32_t *lvec, unsigned long liovcnt, const uint32_t *rvec, unsigned long riovcnt, unsigned long flags);

uint32_t sys_process_vm_writev(uint32_t pid, const uint32_t *lvec, unsigned long liovcnt, const uint32_t *rvec, unsigned long riovcnt, unsigned long flags);
