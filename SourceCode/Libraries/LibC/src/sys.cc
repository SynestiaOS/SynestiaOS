...
_syscall5(int, perf_event_open, uint32_t *, attr_uptr, uint32_t, pid, int, cpu, int, group_fd, unsigned long, flags);
...
_syscall4(int, prlimit64, uint32_t, pid, uint32_t, resource, const uint32_t *, new_rlim, uint32_t *, old_rlim);
