      ...
      for (uint32_t i = 0; i < children->index; i++) {
        ...
        case BUTTON: {
          ...
          button->component.position.x =
              button->component.position.x + container->component.position.x + container->component.padding.left;
        ...
        case LABEL: {
          ...
          label->component.position.x =
              label->component.position.x + container->component.position.x + container->component.padding.left;
        ...
        case PANEL: {
          ...
          innerPanel->component.position.x =
              innerPanel->component.position.x + container->component.position.x + container->component.padding.left;
          innerPanel->component.position.y = innerPanel->component.position.y + container->component.position.y +
                                             container->component.padding.top + yOffset;
        ...
        case CONTAINER: {
          ...
          innerContainer->component.position.x = innerContainer->component.position.x +
                                                 container->component.position.x + container->component.padding.left;
          innerContainer->component.position.y = innerContainer->component.position.y +
                                                 container->component.position.y + container->component.padding.top +
                                                 yOffset;
      ...
      for (uint32_t i = 0; i < children->index; i++) {
        ...
        case BUTTON: {
          ...
          button->component.position.y =
              button->component.position.y + container->component.position.y + container->component.padding.top;
        ...
        case LABEL: {
          ...
          label->component.position.y =
              label->component.position.y + container->component.position.y + container->component.padding.top;
        ...
        case PANEL: {
          GUIPanel *innerPanel = getNode(component, GUIPanel, component);
          innerPanel->component.position.x = innerPanel->component.position.x + container->component.position.x +
                                             container->component.padding.left + xOffset;
          innerPanel->component.position.y =
              innerPanel->component.position.y + container->component.position.y + container->component.padding.top;
          xOffset +=
              innerPanel->component.size.width + innerPanel->component.margin.left + innerPanel->component.margin.right;
          gui_panel_draw(innerPanel);
          break;
        }
        ...
        case CONTAINER: {
          ...
          innerContainer->component.position.y =
              innerContainer->component.position.y + container->component.position.y + container->component.padding.top;
