...
#define expect_check(function, parameter, check_function, check_data)                                                  \
  _expect_check(#function, #parameter, __FILE__, __LINE__, check_function, cast_to_largest_integral_type(check_data),  \
                NULL, 1)
#endif
 ...
 * @see check_expected().
 */
void expect_in_range_count(#function, #parameter, LargestIntegralType minimum, LargestIntegralType maximum,
                           size_t count);
#else
 ...
 * @see check_expected().
 */
void expect_not_in_range_count(#function, #parameter, LargestIntegralType minimum, LargestIntegralType maximum,
                               size_t count);
#else
...
#else
#define expect_any_always(function, parameter) expect_any_count(function, parameter, WILL_RETURN_ALWAYS)
#endif
...
#define assert_ptr_not_equal(a, b)                                                                                     \
  _assert_int_not_equal(cast_ptr_to_largest_integral_type(a), cast_ptr_to_largest_integral_type(b), __FILE__, __LINE__)
#endif
...
#else
#define assert_float_equal(a, b, epsilon) _assert_float_equal((float)a, (float)b, (float)epsilon, __FILE__, __LINE__)
#endif
...
#define assert_float_not_equal(a, b, epsilon)                                                                          \
  _assert_float_not_equal((float)a, (float)b, (float)epsilon, __FILE__, __LINE__)
#endif
...
#define assert_double_equal(a, b, epsilon)                                                                             \
  _assert_double_equal((double)a, (double)b, (double)epsilon, __FILE__, __LINE__)
#endif
...
#define assert_double_not_equal(a, b, epsilon)                                                                         \
  _assert_double_not_equal((float)a, (double)b, (double)epsilon, __FILE__, __LINE__)
#endif
...
void _assert_double_not_equal(const double a, const double n, const double epsilon, const char *const file,
                              const int line);
